...
class ImguiDInputDeviceDS4 : IDirectInputDevice8A {
public:
    GUID deviceGuid;
    ...
    ImguiDInputDeviceDS4() : ImguiDInputDeviceDS4({}, nullptr, nullptr) {}
    ImguiDInputDeviceDS4(GUID deviceGuid, IDirectInput8A* dinput, IDirectInputDevice8A* device) : deviceGuid(deviceGuid), dinput(dinput), device(device) {
        dataFormat = {};
        cooperativeLevelWnd = {};
